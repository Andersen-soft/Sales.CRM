...
type Props = {
    ...
    responsibleSuggestions: Array<{ label: string, name: number }>,
    loadCountry: boolean,
...
const MailExpressSaleForm = ({
    ...
    const translations = {
        ...
        responsible: useTranslation('expressSale.responsible'),
            ...
            <Grid className={classes.row}>
                <CRMAutocompleteSelect
                    ...
                    onChange={responsible => {
                        const changeResponsible = handleChange('responsible');

                        changeResponsible && changeResponsible(responsible);
                    }}
                    containerStyles={{ marginTop: 22 }}
                    label={translations.responsible}
                    maxMenuHeight={200}
                    isLoading={loadResponsible}
                    controlled
                />
            </Grid>
            <Grid className={classes.row}>
...
export default MailExpressSaleForm;
